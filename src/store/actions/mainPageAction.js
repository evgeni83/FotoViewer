...
export const getPhotos = ( numberOfPages, photosPerPage, list, previewPhoto ) => dispatch => {
...
const listOfPhotos = ( numberOfPages, dispatch ) => {
	unsplash.photos.list( numberOfPages  )
		.then( result => {
